...
class TelloUI:
    ...
    def __init__(self, tello, outputpath):
        ...
        # create buttons
        self.btn_snapshot = tki.Button(self.root, text="Img Tracing!",
    ...
    def get_position(self):
        ...
        res = self.tello.send_command('streamon')
        print("streamon :" , res)
    ...
    def read_sdk(self):
        res = self.tello.read_sdk()
        print(res)


    def read_battery(self):
        res = self.tello.read_battery()
        print(res)